...
io.sockets.on('connection', function (socket) {
	...
	//socket.on('chooseRoom', function(username, roomToJoin){
	...
	socket.on('joined', function(us, data){
		socket.broadcast.to(newroom).emit('updatechat', 'SERVER', data + ' has joined this room');
		socket.emit('updatechat', us, data + ' has disconnected');
		io.sockets.in(socket.room).emit('updatechat', data, sanitize(data));
	});
